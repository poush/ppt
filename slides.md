...
<div class="absolute inset-0 bg-black opacity-50" style="z-index: -1" />
...
<v-click><p></p> </v-click>
<v-click><p> - C'est écologique </p> </v-click>
<v-click><p> - C'est rapide</p></v-click>
<v-click><p> - C'est économique</p></v-click>
<v-click><p> - C'est bon pour la santé</p></v-click>
::right::
...
<v-click><p></p> </v-click>
<v-click><p> - Tu ne besoin pas d'un permis de conduire </p></v-click>
<v-click><p> - Tu peux passer de limit des vitesses à 30 km/h</p> </v-click>
<v-click><p> - Tu peux rouler dans sens unique mais en inversant le sens</p> </v-click>
<v-click><p> - Tu peux acheter un café très cher pour flexer</p> </v-click>
<v-click><p> - Tu peux joiner des groupes de vélo chez Strava comme les gens qui courant à pied (j'apprenais le mot "courant" grace à les gens de Hinge)</p> </v-click>
</v-click>
...
1. **Vélib** — le système de vélo en libre-service. Tu as des stations dans toute la ville, et tu peux faire du vélo manuel ou électrique.<br/>
...
2. **Véligo** — un autre système public pour louer des vélos, mais ici tu gardes ton vélo, et ne retourne pas au station apres chaque trajet. <br/>
...
3. **Louer privé** — il y a beaucoup des entreprises privées qui louent des vélos, comme Jump, Lime, et Dott. <br/>
...
4. **Acheter un vélo** — tu peux acheter un vélo. Il y a nombreuses des options pas cher à Paris de acheter un velo. Si c'est ton premier fois, je recommande d'acheter un vélo d'occassion. Tu peux acheter un velo au moins cher que 100 euros. <br/>
